...
{
    internal class FunCode_22 : Item
    {
        ...
        public FunCode_22(string Name, string Address, string Description, string DataType, string swapBytes, string swapWords, string deadband, string outputConversion)
        {
            this.Name = Name;
