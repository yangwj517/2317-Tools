...
{
    internal class FunCode_16 : Item
    {
        ...
        public FunCode_16(string Name, string Address, string Description, string DataType, string swapBytes, string swapWords, string deadband, string outputConversion)
        {
            this.Name = Name;
