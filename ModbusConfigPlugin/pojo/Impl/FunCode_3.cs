...
namespace ModbusConfigPlugin.pojo.Impl
{
    internal class FunCode_3: Item
    {
        ...
        public FunCode_3(string Name, string Address, string Description, string DataType, string scadaScanner, string swapBytes, string swapWords)
        {
            this.Name = Name;
